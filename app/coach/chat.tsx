  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: 'coach',
      content:
        "Hey! I'm Ace, your AI coach. I've reviewed your training plan and I'm here to help you crush your goals. What can I help with today?",
      ...
      <Animated.View entering={FadeIn.duration(300)} style={styles.header}>
        <View style={styles.headerLeft}>
          <View style={styles.aceAvatar}>
            <Text style={styles.aceAvatarText}>A</Text>
          </View>
          <View>
                ...
                >
                  ...
                  {!isUser && (
                    <View style={styles.bubbleAvatarSmall}>
                      <Text style={styles.bubbleAvatarSmallText}>A</Text>
                    </View>
                  )}
